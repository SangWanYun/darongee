...
<html lang="en">
  ...
  <head>
	...
	function commentInsert(){//ajax로 고치자.
		...
		var url = "hcommentInsert.do?";
		url += "gbrdSeq=" + $("#gbrdSeq");
		url += "&userId=" + id;
		url += "&comment=" + $("#comment").val();
		
		$.ajax({
            url : 'hcommentInsert.do',
            method : 'post',
            dataType : "json",
            data : { 
	...
	<input type="hidden" value="${hDetail.hbrdSeq}" name="hbrdSeq"
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <!-- Title -->
          <h1 class="mt-4">${hDetail.hbrdTitle}</h1>

          <!-- Author -->
          <p class="lead">
            by&nbsp;
            <a href="#">${hDetail.regUserNo}</a>
		...
		<div id="hiddenMine"></div>
          ...
          <blockquote class="blockquote">
            <p class="mb-0" id="hbrdContents">${hContents}</p>
...
var id = "<%=id%>";
var regNo = "${hDetail.regUserNo}";
var hbrdSeq = "${hDetail.hbrdSeq}";
var del = "deleteH.do?hbrdSeq=" + hbrdSeq;
