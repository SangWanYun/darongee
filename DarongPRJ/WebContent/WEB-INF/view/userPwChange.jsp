...
<body class="login-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="bootstrap/assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="userPwChangeProc.do" name="sub1">
                        ...
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" placeholder="PASSOWORD" name = "userPw" id="userPw">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                                </span>
                                <input type="text" placeholder="CONFIRM PASSOWORD" class="form-control" id="userPw2"/>
                            </div>
                        </div>
                        <div class="footer text-center">
                            <input type="button" class="btn btn-primary btn-round btn-lg btn-block" value="CHANGE" id="login">
                        </div>
