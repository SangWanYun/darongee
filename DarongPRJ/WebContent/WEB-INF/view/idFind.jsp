        ...
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="idFindProc.do" name="sub1">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" placeholder="Email1" name="userEmail1"class="form-control" id="userEmail1"/>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                        ...
                        <div class="footer text-center">
                            <input type="button" class="btn btn-primary btn-round btn-lg btn-block" value="Find ID" id="login">
                        </div>
