...
function showPages(pageName){
    ...
    contents += '<div class="divRight" style="display:inline-block;float:right;margin-bottom:10px;"><a href="gWriteCheck.do"><input type="button" value="Write" class="btn1"></a></div>';
contents += '<div class="divTable blueTable display" >';
				...
				contents += '<div class="divTableRow">';
						...
						contents += '<div class="divTableHead" style="width:15%">Seller.</div>';
         ...
         $.each(data, function(key, value) {
            	...
            	contents += '<div class="divTableRow"> ';
					...
					contents += '<div class="divTableCell" style="text-align:center;">'+ value.gbrdSeq +'</div>';
					contents += '<div class="divTableCell"><a href="gBoardDetail.do?gbrdSeq='+ value.gbrdSeq +'" style="color:black;" >&nbsp;'+ value.gbrdTitle +'</a></div>';
					contents += '<div class="divTableCell" style="text-align:center;">'+ value.gbrdName+'</div>';
					contents += '<div class="divTableCell" style="text-align:center;">'+ value.regDate +'</div>';
				...
				contents += '<div class="blueTable outerTableFooter">';
					contents += '<div class="tableFootStyle">';
						contents += '<div class="links">';
							...
							contents += '<%
							  String gcnt1 = request.getAttribute("gCount").toString();
		...
		<div class="container">
			...
			<div class="col-md-4 content-center" style="background-color:white;border-radius:15px;height:400px;">
				...
				<div class="card card-login card-plain" style="top:15px;">
					...
					<div class="divRight" style="display:inline-block;float:right;margin-bottom:10px;"><a href="gWriteCheck.do"><input type="button" value="Write" class="btn1"></a></div>
					<div class="divTable blueTable display" >
						...
						<div class="divTableRow"> 
							...
							<div class="divTableCell" style="text-align:center;">${list.gbrdSeq}</div>
							<div class="divTableCell"><a href="gBoardDetail.do?gbrdSeq=${list.gbrdSeq}" style="color:black;">&nbsp;${list.gbrdTitle}</a></div>
							<div class="divTableCell" style="text-align:center;">${list.gbrdName}</div>
							<div class="divTableCell" style="text-align:center;">${list.regDate}</div>
						...
						<div class="blueTable outerTableFooter">
							<div class="tableFootStyle">
								<div class="links">
									...
									<%
									  String gcnt = request.getAttribute("gCount").toString();
									  int cnt = Integer.parseInt(gcnt);//gBoard count get 32
									  int mok = 0;
									  int nam = 0;
