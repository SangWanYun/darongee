...
contents += '<div class="divTable blueTable display" >';
         ...
         $.each(data, function(key, value) {
			...
			contents += '</div>';
				...
				contents += '<br>';
				contents += '<div class="divRight" style="display:inline-block;float:right;"><a href="gWriteCheck.do"><input type="button" value="Write" class="btn1"></a></div>';
			...
			<div class="col-md-4 content-center">
				...
				<div class="card card-login card-plain">
					...
					<div class="divTable blueTable display" >
						...
						<br>
						<div class="divRight" style="display:inline-block;float:right;"><a href="gWriteCheck.do"><input type="button" value="Write" class="btn1"></a></div>
				</div>
			</div>
		</div>
	</div>
