...
// <![CDATA[
	...
	$(document).ready(function (){ // <input type=file> 태그 기능 구현
		...
		var fileName = $(".file-text").val(); // 파일명(절대경로명 또는 단일명) 
		form.ajaxSubmit({ type: 'POST', url: 'singleUploadImageAjax.do', dataType: 'JSON', // 리턴되는 데이타 타입
		...
		alert('파일이 3MB를 초과하였습니다.'); return false; 
		} else { 
